...
position_value = [-0.5188, 0.1152, 0.2184, -0.7739, 0.2664]
position_point = [0.0386, -0.8514, 0.4412, 0.2811]
how_stop = [0.1478, 0.2884, 0.0099, 0.166, -0.0402, -0.2752, 0.1102, -
            0.0019, 0.4718, 0.0842, 0.6281, 0.1745, 0.2198, 0.0737, 0.2636]
